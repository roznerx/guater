      ...
      <main className="max-w-lg mx-auto px-6 py-8 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-3 gap-3">
          <Card className="p-4 text-center">
            <div className="text-2xl font-bold text-blue-deep">{weeklyAverage.toLocaleString()}</div>
            <div className="text-xs font-semibold text-text-muted mt-1">ml / day avg</div>
            <div className="text-xs text-text-muted">last 7 days</div>
          </Card>
          <Card className="p-4 text-center">
            <div className="text-2xl font-bold text-blue-deep">{goalHitRate}%</div>
            <div className="text-xs font-semibold text-text-muted mt-1">goal hit rate</div>
          ...
          <Card className="p-4 text-center">
            ...
            <div className="text-xs font-semibold text-text-muted mt-1">best day</div>
        ...
        <Card>
          ...
          <div className="flex items-center gap-3 mt-4 justify-end">
            <div className="flex items-center gap-1.5">
              <div className="w-3 h-3 rounded-sm bg-slate-soft border border-border"></div>
