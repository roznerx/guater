...
const variants: Record<Variant, string> = {
  primary:   'bg-blue-core text-white dark:text-blue-light border-blue-deep shadow-[3px_3px_0_#0D4F78] hover:enabled:shadow-[1px_1px_0_#0D4F78] hover:enabled:translate-x-0.5 hover:enabled:translate-y-0.5',
