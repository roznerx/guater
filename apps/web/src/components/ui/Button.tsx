...
const variants: Record<Variant, string> = {
  ...
  ghost:     'bg-white dark:bg-dark-card text-slate-deep dark:text-dark-text-secondary border-border dark:border-dark-border shadow-[3px_3px_0_#DDE8F0] hover:enabled:shadow-[1px_1px_0_#DDE8F0] hover:enabled:translate-x-0.5 hover:enabled:translate-y-0.5',
}
