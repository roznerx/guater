...
function CoffeeIcon() {
  return (
    <svg aria-hidden="true" width="36" height="42" viewBox="0 0 48 56" fill="none">
...
function EspressoIcon() {
  return (
    <svg aria-hidden="true" width="30" height="42" viewBox="0 0 40 56" fill="none">
...
function MateIcon() {
  return (
    <svg aria-hidden="true" width="32" height="46" viewBox="0 0 44 62" fill="none">
...
function EnergyDrinkIcon() {
  return (
    <svg aria-hidden="true" width="22" height="38" viewBox="0 0 36 60" fill="none">
...
function SodaIcon() {
  return (
    <svg aria-hidden="true" width="28" height="46" viewBox="0 0 36 60" fill="none">
...
function BeerIcon() {
  return (
    <svg aria-hidden="true" width="32" height="46" viewBox="0 0 40 56" fill="none">
...
function WineIcon() {
  return (
    <svg aria-hidden="true" width="30" height="50" viewBox="0 0 38 58" fill="none">
...
function SparklingIcon() {
  ...
  return (
    <svg aria-hidden="true" width="28" height="46" viewBox="0 0 36 56" fill="none">
      <defs>
        <clipPath id={clipId}>
...
function CustomIcon({ color }: { color: string }) {
  return (
    <svg aria-hidden="true" width="28" height="42" viewBox="0 0 36 52" fill="none">
...
export default function MinBottle({ label, color = '#94A8BA' }: MinBottleProps) {
